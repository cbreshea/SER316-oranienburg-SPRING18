...
=======*/
	...
	static String generateStickers(CalendarDate date) {
		...
		String iurl2 =
				...
				.toExternalForm();
		 String s = "<hr><hr><table border=\"0\" cellpadding=\"0\" width=\"100%\"><tr><td><a href=\"memoranda:importstickers\"><b>"+Local.getString("Import sticker")+"</b></a></td><td><a href=\"memoranda:exportstickerst\"><b>"+Local.getString("Export sticker as .txt file")+"</b></a><td><a href=\"memoranda:exportstickersh\"><b>"+Local.getString("Export sticker as .html file")+"</b></a></td></tr></table>"
